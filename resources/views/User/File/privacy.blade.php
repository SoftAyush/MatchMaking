            ...
            <div class="detail_box">
                <div class="detail_top_curve">
                    <div class="detail_detail_content">
                        <div style="font-family:arial; padding:30px 40px 40px 40px">
                            <div style="width:auto; float:right"><img src="{{asset('user/images/ico-terms.png')}}" alt="" width="164" height="150" style="padding:0 0 0 30px" id="error"/></div>
                            ...
                            <br />
                            <strong>Nepali Online Privacy Protection Act Compliance</strong><br />
                            <br />
                            ...
                            <small>Privacy Policy prepared by Match Making</small> <span></span><span></span>
                            <center>
